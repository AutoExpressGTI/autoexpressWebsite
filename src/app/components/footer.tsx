...
export const Footer = () => {
  return (
    <div className='w-full h-[50vh] flex flex-col items-center justify-center border'>
            <h1>Footer</h1>
            <p> <span>Información de contacto:</span> Se incluirán detalles como dirección, número de teléfono, y correo electrónico.</p>
